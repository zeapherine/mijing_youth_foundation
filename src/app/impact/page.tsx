...
import { fadeInUp, staggerContainer, pageVariants } from "@/lib/animations"
      ...
      <section className="py-24 px-6 md:px-12 lg:px-16 bg-surface-low overflow-hidden">
        ...
        >
           <div className="space-y-4 max-w-xl">
              <motion.h2 variants={fadeInUp} className="font-heading font-black tracking-tight uppercase leading-[0.9]" style={{ fontSize: 'var(--display-md)' }}>Our Cumulative Impact</motion.h2>
              <motion.p variants={fadeInUp} className="text-body-lg text-foreground/50 font-medium italic">&ldquo;The light we give to others eventually shines back on us.&rdquo;</motion.p>
           </div>
